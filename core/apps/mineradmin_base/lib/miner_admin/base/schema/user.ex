defmodule MinerAdmin.Base.Schema.User do
  use Ecto.Schema
  ...
  defp validate_backend(changeset, :update, nil) do
    Base.AuthBackend.user_changeset(:default, changeset, :update)
  end

  defp validate_backend(changeset, type, backend) do
    Base.AuthBackend.user_changeset(backend, changeset, type)
  end
end
